<template>
    <div>
        <button class="bg-green-500 px-2 py-2 text-white rounded shadow-md hover:bg-green-700 focus:bg-green-900" @click="toggleProgress()">{{ this.isWatched ? 'Terminé' : 'Terminer ?' }}</button>
    </div>
</template>
